...
// CMsWordDocument0 包装类

class CMsWordDocument0 : public COleDispatchDriver
{
public:
	CMsWordDocument0(){} // 调用 COleDispatchDriver 默认构造函数
	CMsWordDocument0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CMsWordDocument0(const CMsWordDocument0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
