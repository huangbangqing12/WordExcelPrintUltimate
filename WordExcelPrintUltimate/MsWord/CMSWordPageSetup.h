...
// CMsWordPageSetup 包装器类

class CMsWordPageSetup : public COleDispatchDriver
{
public:
	CMsWordPageSetup(){} // 调用 COleDispatchDriver 默认构造函数
	CMsWordPageSetup(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CMsWordPageSetup(const CMsWordPageSetup& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
