...
// CMsWordDocuments 包装类

class CMsWordDocuments : public COleDispatchDriver
{
public:
	CMsWordDocuments(){} // 调用 COleDispatchDriver 默认构造函数
	CMsWordDocuments(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CMsWordDocuments(const CMsWordDocuments& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
