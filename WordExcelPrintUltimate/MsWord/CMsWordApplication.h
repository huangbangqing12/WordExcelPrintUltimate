...
//#import "C:\\Program Files (x86)\\Microsoft Office\\OFFICE11\\MSWORD.OLB" no_namespace
// CMsWordApplication 包装类

class CMsWordApplication : public COleDispatchDriver
{
public:
	CMsWordApplication(){} // 调用 COleDispatchDriver 默认构造函数
	CMsWordApplication(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CMsWordApplication(const CMsWordApplication& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
