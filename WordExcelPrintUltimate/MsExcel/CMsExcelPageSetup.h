...
// CMsExcelPageSetup 包装器类

class CMsExcelPageSetup : public COleDispatchDriver
{
public:
	CMsExcelPageSetup(){} // 调用 COleDispatchDriver 默认构造函数
	CMsExcelPageSetup(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CMsExcelPageSetup(const CMsExcelPageSetup& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
