...
// CMsExcelWorksheet 包装类

class CMsExcelWorksheet : public COleDispatchDriver
{
public:
	CMsExcelWorksheet(){} // 调用 COleDispatchDriver 默认构造函数
	CMsExcelWorksheet(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CMsExcelWorksheet(const CMsExcelWorksheet& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
