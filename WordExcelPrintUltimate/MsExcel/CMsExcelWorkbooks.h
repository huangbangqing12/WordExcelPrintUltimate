...
// CMsExcelWorkbooks 包装类

class CMsExcelWorkbooks : public COleDispatchDriver
{
public:
	CMsExcelWorkbooks(){} // 调用 COleDispatchDriver 默认构造函数
	CMsExcelWorkbooks(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CMsExcelWorkbooks(const CMsExcelWorkbooks& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
