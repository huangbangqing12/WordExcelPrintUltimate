...
// CMsExcelWorksheets 包装类

class CMsExcelWorksheets : public COleDispatchDriver
{
public:
	CMsExcelWorksheets(){} // 调用 COleDispatchDriver 默认构造函数
	CMsExcelWorksheets(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CMsExcelWorksheets(const CMsExcelWorksheets& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
