...
// CMsExcelWorkbook 包装类

class CMsExcelWorkbook : public COleDispatchDriver
{
public:
	CMsExcelWorkbook(){} // 调用 COleDispatchDriver 默认构造函数
	CMsExcelWorkbook(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CMsExcelWorkbook(const CMsExcelWorkbook& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
