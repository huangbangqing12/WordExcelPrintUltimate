...
// CMsExcelApplication 包装类

class CMsExcelApplication : public COleDispatchDriver
{
public:
	CMsExcelApplication(){} // 调用 COleDispatchDriver 默认构造函数
	CMsExcelApplication(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CMsExcelApplication(const CMsExcelApplication& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
